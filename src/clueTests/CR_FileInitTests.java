...
public class CR_FileInitTests {
	...
	public static void setUp() {
		ClueGame game = new ClueGame("resources/alternative/ClueLayout.csv", 
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		...
		ClueGame game = new ClueGame("resources/alternative/ClueLayoutBadColumns.csv",
				"resources/alternative/ClueLegend.txt");
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		...
		ClueGame game = new ClueGame("resources/alternative/ClueLayoutBadRoom.csv", 
				"resources/alternative/ClueLegend.txt");
		//game.loadRoomConfig();
		game.getBoard().loadBoardConfig();
	...
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException {
		// overloaded Board ctor takes config file name
		ClueGame game = new ClueGame("resources/alternative/ClueLayout.csv",
				"resources/alternative/ClueLegendBadFormat.txt");
		//game.loadRoomConfig();
		game.getBoard().loadBoardConfig();
